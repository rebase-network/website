          ...
          <div className="row">
            ...
            <div className="col-12 col-md mt-5 mt-md-0">
              ...
              <span className="footer-link font-size-normal">
                <a href="https://drive.google.com/drive/folders/1fShs_E_JzLHnPB2uDf38GgDUhoHAa0Fn" target="_blank" className="footer-link font-size-normal mt-2">
                  Media Kits
                </a>
              </span>

              <span className="footer-link font-size-normal">
                <a href="https://drive.google.com/drive/folders/1eRSZrD-m1j6C9Inz1wLFh0e58sbvQdmr" target="_blank" className="footer-link font-size-normal mt-2">
                  Mascot
                </a>
              </span>
            </div>
